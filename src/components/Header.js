...
const Header = () =>{
    ...
    return (
        <div className="flex justify-between items-center w-full absolute  bg-gradient-to-b from-black text-white">
            ...
            {
                user?.displayName && <div className="m-2 cursor-pointer" onClick={handleSignOut}>{"Welcome " + user?.displayName + " !! " }Sign Out</div>
            }
